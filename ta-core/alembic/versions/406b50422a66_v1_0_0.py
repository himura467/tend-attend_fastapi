...
Revision ID: 406b50422a66
Revises: 
Create Date: 2025-01-06 01:03:51.263419
...
def upgrade_common() -> None:
    ...
    op.create_table('host_account',
    sa.Column('host_name', mysql.VARCHAR(length=64), nullable=False, comment='Host Name'),
    ...
    sa.Column('email', mysql.VARCHAR(length=64), nullable=False, comment='Email Address'),
    sa.Column('user_id', mysql.BIGINT(unsigned=True), nullable=True, comment='User ID'),
    ...
    op.create_index(op.f('ix_host_account_created_at'), 'host_account', ['created_at'], unique=False)
    op.create_index(op.f('ix_host_account_updated_at'), 'host_account', ['updated_at'], unique=False)
    op.create_table('guest_account',
    sa.Column('guest_first_name', mysql.VARCHAR(length=64), nullable=False, comment='Guest First Name'),
    sa.Column('guest_last_name', mysql.VARCHAR(length=64), nullable=False, comment='Guest Last Name'),
    sa.Column('guest_nickname', mysql.VARCHAR(length=64), nullable=True, comment='Guest Nickname'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('guest_first_name', 'guest_last_name', 'guest_nickname', 'host_id'),
    sa.UniqueConstraint('user_id'),
    info={'shard_ids': ('common',)},
    mysql_engine='InnoDB'
    )
    op.create_index(op.f('ix_guest_account_created_at'), 'guest_account', ['created_at'], unique=False)
    op.create_index(op.f('ix_guest_account_updated_at'), 'guest_account', ['updated_at'], unique=False)
    op.create_table('host_verification',
    sa.Column('host_email', mysql.VARCHAR(length=64), nullable=False),
    sa.Column('verification_token', mysql.VARCHAR(length=36), nullable=False, comment='Verification Token'),
    sa.Column('token_expires_at', mysql.DATETIME(timezone=True), nullable=False, comment='Token Expires At'),
    sa.Column('id', mysql.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('created_at', mysql.DATETIME(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', mysql.DATETIME(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['host_email'], ['host_account.email'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    info={'shard_ids': ('common',)},
    mysql_engine='InnoDB'
    )
    op.create_index(op.f('ix_host_verification_created_at'), 'host_verification', ['created_at'], unique=False)
    op.create_index(op.f('ix_host_verification_token_expires_at'), 'host_verification', ['token_expires_at'], unique=False)
    op.create_index(op.f('ix_host_verification_updated_at'), 'host_verification', ['updated_at'], unique=False)
    # ### end Alembic commands ###


def downgrade_common() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_host_verification_updated_at'), table_name='host_verification')
    op.drop_index(op.f('ix_host_verification_token_expires_at'), table_name='host_verification')
    op.drop_index(op.f('ix_host_verification_created_at'), table_name='host_verification')
...
def upgrade_shard0() -> None:
    ...
    sa.Column('event_id', mysql.VARCHAR(length=36), nullable=False, comment='Event ID'),
    ...
    info={'shard_ids': ('shard0',)},
    mysql_engine='InnoDB'
    )
    op.create_index(op.f('ix_event_attendance_created_at'), 'event_attendance', ['created_at'], unique=False)
    op.create_index(op.f('ix_event_attendance_updated_at'), 'event_attendance', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_event_attendance_action_log_created_at'), 'event_attendance_action_log', ['created_at'], unique=False)
    op.create_index(op.f('ix_event_attendance_action_log_updated_at'), 'event_attendance_action_log', ['updated_at'], unique=False)
    ...
    sa.Column('id', mysql.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('user_id', mysql.BIGINT(unsigned=True), nullable=False),
    sa.ForeignKeyConstraint(['rrule_id'], ['recurrence_rule.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    info={'shard_ids': ('shard0',)},
    mysql_engine='InnoDB'
    )
    op.create_table('event',
    sa.Column('summary', mysql.VARCHAR(length=64), nullable=False, comment='Summary'),
    sa.Column('location', mysql.VARCHAR(length=64), nullable=True, comment='Location'),
    sa.Column('start', mysql.DATETIME(timezone=True), nullable=False, comment='Start'),
    ...
    sa.Column('timezone', mysql.VARCHAR(length=64), nullable=False, comment='Timezone'),
    sa.Column('id', mysql.VARCHAR(length=36), autoincrement=False, nullable=False),
    sa.Column('created_at', mysql.DATETIME(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', mysql.DATETIME(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('user_id', mysql.BIGINT(unsigned=True), nullable=False),
    sa.ForeignKeyConstraint(['recurrence_id'], ['recurrence.id'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade_shard0() -> None:
    ...
    op.drop_index(op.f('ix_event_attendance_action_log_updated_at'), table_name='event_attendance_action_log')
    op.drop_index(op.f('ix_event_attendance_action_log_created_at'), table_name='event_attendance_action_log')
